                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('gruporutas.destroy',$gruporuta->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('gruporutas.show',$gruporuta->id) }}"><i class="fa fa-fw fa-eye"></i> Ver</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('gruporutas.edit',$gruporuta->id) }}"><i class="fa fa-fw fa-edit"></i> Editar</a>
                                                    @csrf
                                                    @method('DELETE')
