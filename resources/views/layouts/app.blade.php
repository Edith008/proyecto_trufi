                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            @if(auth()->user()->role_id == 1)
                                ...
                                <a class="nav-link" href="{{ route('usuarios.index') }}">{{ __('Gestionar Usuarios') }}</a>
                                <a class="nav-link" href="{{ route('empleados.index') }}">{{ __('Gestionar Empleados') }}</a>
                                <a class="nav-link" href="{{ route('roles.index') }}">{{ __('Gestionar Roles') }}</a>

                            @endif
                            
                                <a class="nav-link" href="{{ route('socios.index') }}">{{ __('Gestionar Socios') }}</a>
